---
title: "image"
datePublished: "2026-01-07T01:00:32.803Z"
author: "Tony Wong"
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "Article",
      "@id": "https://github.com/slompo-bizdev/TonyWong/blob/main/content/image-mk3bar37#article",
      "headline": "image",
      "name": "image",
      "datePublished": "2026-01-07T01:00:32.803Z",
      "dateModified": "2026-01-07T01:00:32.803Z",
      "author": {
        "@type": "Person",
        "@id": "https://www.linkedin.com/in/agiletony/",
        "name": "Tony Wong"
      ...
      "articleBody": "4 | Pitfalls to anticipate\n\n1. **Synthetic empathy creep** – assuming the model *understands* because it mimics empathic language.\n\n2. **Analysis paralysis** – when leaders ignore intuitive disquiet because the model’s numbers look airtight.\n\n3. **Objective myopia** – over-optimising the proxy metric after its business relevance has expired.\n\nMitigation: schedule periodic **“metric funerals,”** empower staff to raise **somatic red flags**, and keep a standing **alignment squad** responsible for principle drift.",
      "text": "4 | Pitfalls to anticipate\n\n1. **Synthetic empathy creep** – assuming the model *understands* because it mimics empathic language.\n\n2. **Analysis paralysis** – when leaders ignore intuitive disquiet because the model’s numbers look airtight.\n\n3. **Objective myopia** – over-optimising the proxy metric after its business relevance has expired.\n\nMitigation: schedule periodic **“metric funerals,”** empower staff to raise **somatic red flags**, and keep a standing **alignment squad** responsible for principle drift.",
      "description": "4 | Pitfalls to anticipate\n\n1. **Synthetic empathy creep** – assuming the model *understands* because it mimics empathic language.\n\n2. **Analysis paralysis** – when leaders ignore intuitive disquiet because the model’s numbers look airtight.\n\n3. **Objective myopia** – over-optimising the proxy metric after its business relevance has expired.\n\nMitigation: schedule periodic **“metric funerals,”** empower staff to raise **somatic red flags**, and keep a standing **alignment squad** responsible for ...",
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.linkedin.com/in/agiletony/"
      },
    ...
    {
      "@type": "FAQPage",
      "@id": "https://github.com/slompo-bizdev/TonyWong/blob/main/content/image-mk3bar37#faq",
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.linkedin.com/in/agiletony/"
      },
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "What is 'synthetic empathy creep'?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Synthetic empathy creep refers to the assumption that a model understands because it mimics empathic language.",
            "author": {
              "@type": "Person",
              "@id": "https://www.linkedin.com/in/agiletony/",
              "name": "Tony Wong"
        ...
        {
          "@type": "Question",
          "name": "What might cause 'analysis paralysis' in decision-making?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Analysis paralysis can occur when leaders ignore intuitive disquiet because the model’s numbers appear to be airtight.",
            "author": {
              "@type": "Person",
              "@id": "https://www.linkedin.com/in/agiletony/",
              "name": "Tony Wong"
        ...
        {
          "@type": "Question",
          "name": "What does 'objective myopia' involve?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Objective myopia involves over-optimizing a proxy metric after its business relevance has expired.",
            "author": {
              "@type": "Person",
              "@id": "https://www.linkedin.com/in/agiletony/",
              "name": "Tony Wong"
        ...
        {
          "@type": "Question",
          "name": "What strategies are suggested for mitigating these pitfalls?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Suggested strategies for mitigation include scheduling periodic 'metric funerals,' empowering staff to raise 'somatic red flags,' and maintaining a standing alignment squad responsible for addressing principle drift.",
            "author": {
              "@type": "Person",
              "@id": "https://www.linkedin.com/in/agiletony/",
              "name": "Tony Wong"
...
### What is 'synthetic empathy creep'?

Synthetic empathy creep refers to the assumption that a model understands because it mimics empathic language.


### What might cause 'analysis paralysis' in decision-making?

Analysis paralysis can occur when leaders ignore intuitive disquiet because the model’s numbers appear to be airtight.


### What does 'objective myopia' involve?

Objective myopia involves over-optimizing a proxy metric after its business relevance has expired.


### What strategies are suggested for mitigating these pitfalls?

Suggested strategies for mitigation include scheduling periodic 'metric funerals,' empowering staff to raise 'somatic red flags,' and maintaining a standing alignment squad responsible for addressing principle drift.
